...
1. Clone repo.
2. Create a Postgres database on the Postgres server. This needs to be PostGIS enabled. To do this, after creating the database type 'CREATE EXTENSION postgis;' and 'CREATE EXTENSION postgis_topology;' in psql.
