...
1. Copying Past Events Photos from production
   1. Use `scp` or `docker cp` to copy the photos from production to your test instance. They are in either `disasterinfosite/media/img/photos` or `disasterinfosite/static/img/photos`.
